...
* WPSSO can express some location information using meta tags, but consider using the WPSSO JSON extension as well to include all the location information as Schema JSON-LD markup.
