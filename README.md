...
<li>The Free version adds location information to the main entity (aka the primary Schema type) of a <em>blog front page</em>. If you use a <em>static front page</em>, or would like to include location information about the content in other posts / pages, you'll need the Pro version.</li>
<li>WPSSO can express some location information using meta tags, but consider using the WPSSO JSON extension to include all of the available location information in the Schema JSON-LD markup for Google.</li>
</ul>
