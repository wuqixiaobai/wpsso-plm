...
<li>WPSSO can express some location information using meta tags, but consider using the WPSSO JSON extension as well to include all of the available location information as Schema JSON-LD markup.</li>
</ul>
