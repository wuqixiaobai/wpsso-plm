...
<li>Combine with the <a href="http://wpsso.com/extend/plugins/wpsso-json/">WPSSO Schema JSON-LD (WPSSO JSON) Pro</a> version extension to include complete Schema Place and Local Business JSON-LD markup.</li>
</ul>
